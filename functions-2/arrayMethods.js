...
const evenNumbers = mixedNumbers.filter((mixedNum, i, mixedNumers) => mixedNum % 2 === 0)
...
// CODE HERE
const postTaxPrices = prices.map((priceTag) => priceTag * 1.07);
...
// CODE HERE
const totalPopulation = populations.reduce((bucket, element) => bucket + element)
...
*/
const orderTotals = orders.map(orders => orders.price + (orders.tax * orders.price))
